...
function arenaState(step: Step, withPain = false) {
  return {
    ...
    moreSlot: {
      ...
      sub: '가맹점 2,500개 · 슈퍼바이저 60명 · 인당 30~40개점 담당 [예시]',
    },
    ...(withPain
      ? {
          painPopup: {
...
export const chapter00SupervisorOverload: Chapter = {
  ...
  narration:
    '가맹본부의 현장 접점은 슈퍼바이저입니다. 한 사람이 30~40개 점포를 맡고, 점주들과는 각자의 개인 카톡방으로 이어져 있습니다. 한 점포를 응대하는 동안 나머지는 기다립니다. 본사가 공지를 내려도 누가 읽었는지 알 수 없고, 슈퍼바이저가 그만두면 담당하던 점포의 이력이 통째로 사라집니다. "가맹점 2,500개의 현장이, 슈퍼바이저 60명의 개인 폰 안에 있습니다."',
  stage: 'manufacturing',
  states: [
    {
      index: 0,
