...
const GEN: MfgDashGenTab = {
  ...
  rooms: {
    ...
    bars: [
      { label: '수도권 1·2권역', value: 682, state: 'SV 1인당 40.1', tone: 'hi', tip: 'SV 17명 · SLA 92%' },
      { label: '호남권', value: 548, state: 'SV 1인당 42.2', tone: 'hi', tip: 'SV 13명 · SLA 86%' },
      { label: '영남권', value: 540, state: 'SV 1인당 41.5', tone: 'hi', tip: 'SV 13명 · SLA 89%' },
      { label: '수도권 3권역', value: 418, state: 'SV 1인당 41.8', tone: 'mid', tip: 'SV 10명 · SLA 84%' },
      { label: '충청권', value: 312, state: 'SV 1인당 44.6 · 주의', tone: 'low', tip: 'SV 7명 · SLA 71%' },
    ],
    note: '막대 = 권역 점포 수 · 아래 값 = SV 1인당 담당 점포 · 휴면(3개월 무활동) 점포방 별도 38개',
    metricLabel: '점포',
    unit: '개',
  },
  agents: {
