  ...
  states: [
    ...
    },
    {
      ...
      execDashboardFull: {
        ...
        drilldown: undefined,
        beforeAfter: {
          title: 'Cowork+ 도입 전 vs 후 · 매출 기여 지표 비교',
          beforeTitle: 'Before — 개인 카톡 업무',
          afterTitle: 'After — Cowork+ 도입',
          rows: [
            { label: '설계서 응답 시간', before: '평균 3일', after: '평균 5분', highlight: 'good' },
            { label: '계약 전환율', before: '31%', after: '67%', highlight: 'good' },
            { label: '설계사 1인당 월 계약', before: '4.1건', after: '6.4건 (+2.3)', highlight: 'good' },
            { label: '수기 입력 오류율', before: '15%', after: '0%', highlight: 'good' },
            { label: 'GA 데이터 추적', before: '불가', after: '실시간', highlight: 'good' },
            { label: '문서 자산화율', before: '0%', after: '91%', highlight: 'good' },
          ],
          tagline: '"이 속도 경쟁에서 이기는 보험사가 GA 채널을 가져갑니다."',
        },
        scriptBody:
